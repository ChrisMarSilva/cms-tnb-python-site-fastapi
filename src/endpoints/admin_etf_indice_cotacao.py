...
#
#
# bp_admin_etf_indice_cotacao = Blueprint('admin_etf_indice_cotacao', __name__, url_prefix='/EtfIndiceCotacao')
#
#
# @bp_admin_etf_indice_cotacao.route('/')
# @login_required
# # @tracing.trace()
...
#
#
# @bp_admin_etf_indice_cotacao.route('/salvar', methods=['GET', 'POST'])
# @login_required
# # @tracing.trace()
# @flask_optimize.optimize('json')
# def salvar():
...
#
#
# @bp_admin_etf_indice_cotacao.route('/carregar', methods=['GET', 'POST'])
# @login_required
# # @tracing.trace()
# @flask_optimize.optimize('json')
# def carregar():
...
#
#
# @bp_admin_etf_indice_cotacao.route('/AtualizaCotacao', methods=['GET', 'POST'])
# @login_required
# # @tracing.trace()
# @flask_optimize.optimize('json')
# def atualiza_ctacao():
