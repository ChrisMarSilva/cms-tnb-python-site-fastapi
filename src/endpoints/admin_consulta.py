...
@router.get(path='/ComandoSQL', status_code=_fastapi.status.HTTP_200_OK)
async def comando_sql(db: _orm.Session = _fastapi.Depends(_database.base.get_db), current_user=_fastapi.Depends(manager)):
