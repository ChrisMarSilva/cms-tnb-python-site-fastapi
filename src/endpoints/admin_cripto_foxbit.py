...
@router.get(path='/processar', status_code=_fastapi.status.HTTP_200_OK)
async def processar(db: _orm.Session = _fastapi.Depends(_database.base.get_db), current_user=_fastapi.Depends(manager)):
