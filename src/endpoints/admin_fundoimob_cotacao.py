...
#
#
# bp_admin_fundoimob_cotacao = Blueprint('admin_fundoimob_cotacao', __name__, url_prefix='/FiiFundoImobCotacao')
#
#
# @bp_admin_fundoimob_cotacao.route('/')
# @login_required
# # @tracing.trace()
...
#     return render_template(template_name_or_list="admin_fundoimob_cotacao.html")
#
#
# @bp_admin_fundoimob_cotacao.route('/grid', methods=['GET', 'POST'])
# @login_required
# # @tracing.trace()
...
#
#         rows = FiiFundoImobCotacao.buscar_todos( )
#
#         lista = [
#             [
#                 str(row['FUNDOCODIGO']),
...
#
#
# @bp_admin_fundoimob_cotacao.route('/salvar', methods=['GET', 'POST'])
# @login_required
# # @tracing.trace()
# @flask_optimize.optimize('json')
# def salvar():
...
#
#         fundo = FiiFundoImob.get_by_codigo(codigo=str(codigo))
#
#         if not fundo:
...
#
#
# @bp_admin_fundoimob_cotacao.route('/carregar', methods=['GET', 'POST'])
# @login_required
# # @tracing.trace()
# @flask_optimize.optimize('json')
# def carregar():
...
#
#
# @bp_admin_fundoimob_cotacao.route('/AtualizaCotacao', methods=['GET', 'POST'])
# @login_required
# # @tracing.trace()
# @flask_optimize.optimize('json')
# def atualiza_ctacao():
...
#
#         try:
#             url = 'https://br.financas.yahoo.com/quote/'+codigo+'.SA/'
...
#             return make_response(get_json_retorno_dados(msg='Cotação do Ativo: '+codigo+' - Sem Valoes'), 200)
#
#         cotacao = FiiFundoImobCotacao.get_by_fundo(id_fundo=int(fundo.id))
#         if not cotacao:
#             cotacao = FiiFundoImobCotacao(id_fundo=int(fundo.id))
