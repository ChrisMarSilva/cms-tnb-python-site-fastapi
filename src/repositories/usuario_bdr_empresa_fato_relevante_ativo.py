...
# class UsuarioBDREmpresaFatoRelevanteAtivo(db.Model):

#     __tablename__ = "TBBDR_EMPRESA_FATORELEVANTE_ATIVO"

#     id_fato = db.Column('IDFATO', db.Integer, db.ForeignKey('TBBDR_EMPRESA_FATORELEVANTE.ID'), primary_key=True, nullable=False, index=True)
