...
from src.models.usuario_bdr_empresa_fato_relevante_ativo import UsuarioBDREmpresaFatoRelevanteAtivoModel
# # from app.models.log_erro import LogErro


class UsuarioBDREmpresaFatoRelevanteAtivoRepository:
