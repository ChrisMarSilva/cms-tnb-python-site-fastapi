...
class UsuarioFiiFundoImobFatoRelevanteAtivo(db.Model):

    __tablename__ = "TBFII_FUNDOIMOB_FATORELEVANTE_ATIVO"

    id_fato = db.Column('IDFATO', db.Integer, db.ForeignKey('TBFII_FUNDOIMOB_FATORELEVANTE.ID'), primary_key=True, nullable=False, index=True)
