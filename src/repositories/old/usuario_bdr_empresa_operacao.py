...
class UsuarioBDREmpresaOperacao(db.Model):

    __tablename__ = "TBBDR_OPERACAO"
    ...
    id_lancamento = db.Column('IDLANC', db.Integer, db.ForeignKey('TBBDR_LANCAMENTO.ID'), nullable=False, index=True)
    ...
    @classmethod
    def get_all(cls, id_usuario: int = None, id_bdr: int = None, dt_ini: str = None, dt_fim: str = None, categoria: str = None, tipo: str = None):
        try:
    ...
    @classmethod
    def buscar_preco_medio(cls, id_usuario: int = None, id_bdr: int = None, dt_fim: str = None):
    ...
    @classmethod
    def buscar_preco_medio_antes(cls, id_usuario: int = None, id_bdr: int = None, dt_fim: str = None):
        query = """ SELECT O.VLRPRECOMEDIO FROM TBBDR_OPERACAO O WHERE O.ID = ( SELECT MAX(OO.ID) FROM TBBDR_OPERACAO OO WHERE OO.IDUSUARIO = :IDUSUARIO and OO.IDBDR = :IDBDR AND OO.QUANTACUMULADO > 0 AND OO.SITUACAO = 'A' """
        if dt_fim: query += " AND OO.DATA < :DATAFIM "
        query += " ) "
        params = {}
    ...
    @classmethod
    def buscar_total_bonus(cls, id_usuario: int = None, id_bdr: int = None, dt_fim: str = None):
    ...
    @classmethod
    def buscar_valor_total_compra(cls, id_usuario: int = None, id_bdr: int = None, dt_fim: str = None):
    ...
    @classmethod
    def buscar_valor_total_bonus(cls, id_usuario: int = None, id_bdr: int = None, dt_fim: str = None):
    ...
    @classmethod
    def buscar_valor_total_venda(cls, id_usuario: int = None, id_bdr: int = None, id_lanc: int = None, dt_fim: str = None):
    ...
    @classmethod
    def excluir_tudo_ativo(cls, id_usuario: int, id_bdr: int, commit: bool = True):
        try:
    ...
    def descricao_categoria(cls, categoria: str) -> str:
        if categoria == 'C': return 'Comum'
        elif categoria == 'D': return 'Day-Trade'
        else: return 'Desconhecida'

    @classmethod
    def descricao_situacao(cls, situacao: str) -> str:
        if situacao == 'A': return 'Ativo'
        elif situacao == 'F': return 'Finalizada'
        else: return 'Desconhecida'
