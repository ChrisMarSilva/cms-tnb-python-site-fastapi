...
class UsuarioETFIndiceLancamento(db.Model):

    __tablename__ = "TBETF_LANCAMENTO"
    ...
    @classmethod
    def get_menor_ano(cls, id_usuario: int = None, id_indice: int = None):
        try:
    ...
    @classmethod
    def get_maior_ano(cls, id_usuario: int = None, id_indice: int = None):
        try:
    ...
    @classmethod
    def buscar_menor_ano(cls, id_usuario: int = None, id_indice: int = None):
    ...
    @classmethod
    def buscar_maior_ano(cls, id_usuario: int = None, id_indice: int = None):
    ...
    def __repr__(self):
        return '<UsuarioETFIndiceLancamento {str(self.id)}>'
