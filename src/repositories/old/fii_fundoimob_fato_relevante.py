...
class FiiFundoImobFatoRelevante(db.Model):

    __tablename__ = "TBFII_FUNDOIMOB_FATORELEVANTE"

    id = db.Column('ID', db.Integer, primary_key=True, autoincrement=True)
    id_fundo = db.Column('IDFUNDO', db.Integer, nullable=True, index=True)  # db.ForeignKey('TBFII_FUNDOIMOB.ID')
    nm_fundo = db.Column('NMFUNDO', db.String(250), nullable=True, index=True)
    ...
    def __init__(self, id: int = None, id_fundo: int = None, nm_fundo: str = None, data_env: str = None,
    ...
    @classmethod
    def get_all(cls, id_fundo: int = None, dt_env_ini: str = None, dt_env_fim: str = None, reg_inicio: int = 1, qtde_por_pagina: int = 100):
        filters = []
    ...
    @classmethod
    def get_total(cls, id_fundo: int = None, dt_env_ini: str = None, dt_env_fim: str = None):
        filters = []
        filters.append(cls.situacao == 'A')
        if id_fundo: filters.append(cls.id_fundo == id_fundo)
        if dt_env_ini: filters.append(cls.data_env >= dt_env_ini)
    ...
    @classmethod
    def buscar_todos(cls, id_fundo: int = None, dt_env_ini: str = None, dt_env_fim: str = None, reg_inicio: int = 1, qtde_por_pagina: int = 100):
    ...
    @classmethod
    def buscar_qtde_total_fato(cls, id_fundo: int = None, dt_env_ini: str = None, dt_env_fim: str = None):
    ...
    def __repr__(self):
        return '<FiiFundoImobFatoRelevante {str(self.id)} - {self.nome} - {self.cnpj}>'
