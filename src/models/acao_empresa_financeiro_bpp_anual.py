...
class ACAOEmpresaFinanceiroBPPAnualModel(_database.session.Base):

    __tablename__ = "TBEMPRESA_FINAN_BPP_ANUAL"
    ...
    def __init__(self, id: int = None, cod_cvm: str = None, ano_refer: str = None, vlr_passivo_total: float = 0.0, vlr_circulante: float = 0.0,
    ...
    def __repr__(self):
        return '<ACAOEmpresaFinanceiroBPPAnual {str(self.id)}>'
