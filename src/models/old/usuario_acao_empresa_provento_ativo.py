...
class UsuarioACAOEmpresaProventoAtivo(db.Model):

    __tablename__ = "TBEMPRESA_PROVENTO_ATIVO"

    id_provento = db.Column('IDEMPRPROV', db.Integer, db.ForeignKey('TBEMPRESA_PROVENTO.ID'), primary_key=True, nullable=False, index=True)
