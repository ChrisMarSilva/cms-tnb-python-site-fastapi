...
class UsuarioACAOEmpresaOperacaoModel(_database.session.Base):
    ...
    id_lancamento = _sql.Column('IDLANC', _sql.Integer, _sql.ForeignKey('TBLANCAMENTO.ID'), nullable=False, index=True)
