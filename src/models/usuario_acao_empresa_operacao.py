...
# class UsuarioACAOEmpresaOperacao(db.Model):

#     __tablename__ = "TBOPERACAO"
...
#     id_lancamento = db.Column('IDLANC', db.Integer, db.ForeignKey('TBLANCAMENTO.ID'), nullable=False, index=True)
...
#     @classmethod
#     def get_all(cls, id_usuario: int = None, id_ativo: int = None, dt_ini: str = None, dt_fim: str = None, categoria: str = None, tipo: str = None):
#         try:
...
#     @classmethod
#     def buscar_preco_medio(cls, id_usuario: int = None, id_ativo: int = None, dt_fim: str = None):
...
#     @classmethod
#     def buscar_preco_medio_antes(cls, id_usuario: int = None, id_ativo: int = None, dt_fim: str = None):
#         query = """ SELECT O.VLRPRECOMEDIO FROM TBOPERACAO O WHERE O.ID = ( SELECT MAX(OO.ID) FROM TBOPERACAO OO WHERE OO.IDUSUARIO = :IDUSUARIO and OO.IDATIVO = :IDATIVO AND OO.QUANTACUMULADO > 0 AND OO.SITUACAO = 'A' """
#         if dt_fim: query += " AND OO.DATA < :DATAFIM "
#         query += " ) "
#         params = {}
...
#     @classmethod
#     def buscar_total_compra(cls, id_usuario: int = None, id_ativo: int = None, dt_fim: str = None):
...
#     @classmethod
#     def buscar_total_bonus(cls, id_usuario: int = None, id_ativo: int = None, dt_fim: str = None):
...
#     @classmethod
#     def buscar_total_venda(cls, id_usuario: int = None, id_ativo: int = None, id_lanc: int = None, dt_fim: str = None):
...
#     @classmethod
#     def buscar_valor_total_compra(cls, id_usuario: int = None, id_ativo: int = None, dt_fim: str = None):
...
#     @classmethod
#     def buscar_valor_total_bonus(cls, id_usuario: int = None, id_ativo: int = None, dt_fim: str = None):
...
#     @classmethod
#     def buscar_valor_total_venda(cls, id_usuario: int = None, id_ativo: int = None, id_lanc: int = None, dt_fim: str = None):
...
#     @classmethod
#     def excluir_tudo_ativo(cls, id_usuario: int, id_ativo: int, commit: bool = True):
#         try:
