...
class ACAOEmpresaFinanceiroDFCAnualModel(_database.session.Base):

    __tablename__ = "TBEMPRESA_FINAN_DFC_ANUAL"
    ...
    def __init__(self, id: int = None, cod_cvm: str = None, ano_refer: str = None, vlr_caixa_liquido_operac: float = 0.0,
    ...
    def __repr__(self):
        return '<ACAOEmpresaFinanceiroDFCAnual {str(self.id)}>'
