...
class UsuarioBDREmpresaOperacaoModel(_database.session.Base):
    ...
    id_lancamento = _sql.Column('IDLANC', _sql.Integer, _sql.ForeignKey('TBBDR_LANCAMENTO.ID'), nullable=False, index=True)
