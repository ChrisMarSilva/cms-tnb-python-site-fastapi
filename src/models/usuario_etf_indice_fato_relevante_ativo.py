...
class UsuarioETFIndiceFatoRelevanteAtivoModel(_database.session.Base):

    __tablename__ = "TBETF_FATORELEVANTE_ATIVO"

    id_fato = _sql.Column('IDFATO', _sql.Integer, _sql.ForeignKey('TBETF_FATORELEVANTE.ID'), primary_key=True, nullable=False, index=True)
